...
const BestSelling = () => {
    ...
    return (
        <div id='best' className='px-3 sm:px-6 my-20 sm:my-30 max-w-6xl mx-auto'>
            ...
            <div className='mt-8 sm:mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-6 xl:gap-12'>
